...
namespace ElectronicsShop.Migrations
{
    ...
    [Migration("20260512100635_AddStockManagementModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronicsShop.Models.RepairRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElectronicsShop.Models.RepairStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElectronicsShop.Models.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElectronicsShop.Models.StockEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElectronicsShop.Models.StockHistoryLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StockHistoryLogs");
                });

            modelBuilder.Entity("ElectronicsShop.Models.StockInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElectronicsShop.Models.RepairRequest", b =>
                {
                    b.HasOne("ElectronicsShop.Models.ApplicationUser", "Customer")
            ...
            modelBuilder.Entity("ElectronicsShop.Models.RepairStatusHistory", b =>
                {
                    b.HasOne("ElectronicsShop.Models.RepairRequest", "RepairRequest")
            ...
            modelBuilder.Entity("ElectronicsShop.Models.StockEntry", b =>
                {
                    ...
                    b.HasOne("ElectronicsShop.Models.StockInvoice", "StockInvoice")
            ...
            modelBuilder.Entity("ElectronicsShop.Models.StockHistoryLog", b =>
                {
                    b.HasOne("ElectronicsShop.Models.ApplicationUser", "AdminUser")
                        .WithMany()
